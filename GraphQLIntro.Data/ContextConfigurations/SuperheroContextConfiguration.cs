...
namespace GraphQLIntro.Data.ContextConfigurations
{
    public class SuperheroContextConfiguration : IEntityTypeConfiguration<SuperHeroe>
    {
        private Guid[] _ids;
        ...
        public void Configure(EntityTypeBuilder<SuperHeroe> builder)
        {
            builder.HasData(
                new SuperHeroe
                {
